...
from clubcollege import app, db, bcrypt
from clubcollege.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
from clubcollege.models import User, Post
...
def register():
    ...
    if form.validate_on_submit():
        ...
        # print(domain)
        if(len(domain) == 3 and domain[0] == 'nitmz' and domain[1] == 'ac' and domain[2] == 'in'):
            ...
            flash('Use Your NIT Mizoram Credentials to register!!', 'danger')
